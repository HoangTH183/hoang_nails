...
class CompanyManagerUpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            'name' => 'required|min:3',
            'email' => 'required|email|unique:users,email,'.$this->owner,
            'password' => 'required|min:6',
            'username' => 'required|min:4|unique:users,username,'.$this->owner,
            'phone' => 'required',
