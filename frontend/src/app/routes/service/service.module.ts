...
const COMPONENTS = [ServiceListComponent, ServiceEditComponent, ServiceCreateComponent, ServiceCategoryListComponent, ServiceCategoryEditComponent, ServiceCategoryCreateComponent];
