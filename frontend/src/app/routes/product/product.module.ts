...
const COMPONENTS = [ProductListComponent, ProductEditComponent, ProductCreateComponent, ProductCategoryListComponent, ProductCategoryEditComponent, ProductCategoryCreateComponent];
